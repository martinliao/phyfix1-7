                    ...
                    <table class="table table-bordered table-condensed table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="sorting<?=($filter['sort']=='apply_s_date2 asc')?'_asc':'';?><?=($filter['sort']=='apply_s_date2 desc')?'_desc':'';?>" data-field="apply_s_date2" >二次報名起日</th>
                                <th class="sorting<?=($filter['sort']=='apply_e_date2 asc')?'_asc':'';?><?=($filter['sort']=='apply_e_date2 desc')?'_desc':'';?>" data-field="apply_e_date2" >二次報名迄日</th>
                        ...
                        <?php foreach ($list as $row) { ?>
                            <tr>
                                ...
                                <td><?=substr($row['apply_s_date2'], 0, -8);?></td>
                                <td><?=substr($row['apply_e_date2'], 0, -8);?></td>
